...
<title>Insert title here</title>
    ...
    <script src="https://kit.fontawesome.com/e598410924.js" crossorigin="anonymous"></script>
    <!--  adding external css file into this jsp file -->
    <link href="home_Food_Css.css" rel="stylesheet">
    <!--  adding external Javascript file into this jsp file  -->
    <script type="text/javascript" src="home_Food_JS.js"></script>
...
<div class="container">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a class="nav-link" href="#emSection" id="navItem2">Explore Menu</a>
                        <a class="nav-link" href="#dpSection" id="navItem3">Delivery & Payment</a>
    ...
    <div class="explore-menu-section pt-5 pb-5" id="emSection">
        <div class="container">
            <div class="row">
                <div class="col-12">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <button class="custom-button" onclick ="watchVideoHome()">Watch Video</button>
                </div>
            </div>
        </div>
    </div>
    <div class="delivery-and-payment-section pt-5 pb-5" id="dpSection">
        <div class="container">
            <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="all-follow-item d-flex flex-rows justify-content-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <h1 class="footer-section-mail-id">GoodHealthEasyFature@gmail.com</h1>
                        <p class="footer-section-address">
                            ushri khurd post-hasanpura police-station:M H Nagar
                            <br>
